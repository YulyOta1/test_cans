...
// Disable Windows-specific attributes for Linux/GCC compilation
#undef __stdcall
#define __stdcall
...
// Replace complex Windows property system with simple member variables
#undef PROPERTY
...
// Fix for missing setter functions in original header
#define set_is_tx(value) (FProperties = value ? (FProperties | 0x01) : (FProperties & ~0x01))
#define set_is_std(value) (FProperties = value ? (FProperties & ~0x04) : (FProperties | 0x04))
#define set_is_data(value) (FProperties = value ? (FProperties & ~0x02) : (FProperties | 0x02))

// Prevent duplicate struct definition
#ifndef _TLIBCANFD_DEFINED
#define _TLIBCANFD_DEFINED
